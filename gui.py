...
class MainMenu :
  ...
  def __init__(self, master,frameRef):
	...
	filemenu.add_command(label="Open bibtex file", command= lambda : self.readBibFile(''))
  ...
  def readBibFile(self,filename) :
	self.data = readBibFile(self,filename)
	print "self.data = "
	print self.data
